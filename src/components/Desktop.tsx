    ...
    <IonPage className="">
      <IonContent className="">
        <div className="w-full h-[800px] bg-slate-200 relative flex">
          ...
          <div className="w-[640px] h-[800px] bg-[url('/assets/images/desktop/image-hero.jpg')] bg-cover bg-center"></div>
        ...
        <div className="w-[1110px]  m-auto my-32">
          <div className="flex  w-full ">
            ...
            <div className="w-[57%] h-[400px] bg-[url('/assets/images/desktop/image-grid-1.jpg')]"></div>
          </div>
          <div className="flex w-full mt-20">
            <div className="w-[635px] bg-cover bg-center bg-[url('/assets/images/desktop/image-grid-2.jpg')]"></div>
            <div className="w-[475px]">
              <div className="ml-8 w-[445px] h-[313px] bg-[url('/assets/images/desktop/image-grid-3.jpg')] bg-cover bg-center"></div>
