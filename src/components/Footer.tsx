...
const Footer: FC<FooterBgcolor> = ({ bgcolor }) => {
  return (
    ...
    >
      <div className="w-full md:w-[80%]  h-80 md:h-[84px] flex flex-col md:flex-row items-start justify-between p-6">
        <img src="/images/logo-light.svg" alt="Logo" width={160} height={58} />
        <div className="md:w-[420px] text-white">
          <TextFour />
        </div>
        <div className="flex md:h-[84px] justify-end items-start">
          <svg
            className={`w-8 h-8  p-1  hover:cursor-pointer
                ${
                  bgcolor === "black"
                    ? "hover:fill-orange-400 fill-white"
                    : "hover:fill-white fill-black"
                }`}
